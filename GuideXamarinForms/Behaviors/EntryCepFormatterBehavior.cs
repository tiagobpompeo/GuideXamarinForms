...
namespace GuideXamarinForms.Behaviors
{

    public class EntryCepFormatterBehavior : Behavior<Entry>
    {
        public EntryCepFormatterBehavior()
        {
        }
        ...
        void OnEntryTextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (ev.NewTextValue != ev.OldTextValue)
            {
                ...
                // removendo os os digitos excedentes 
                if (text.Length > 8)
                {
                    text = text.Remove(8);
                }
